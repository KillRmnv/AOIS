...
public class TableMethod {
    ...
    private void delRedundantImplicants(Set<Integer> redundantImplicants, Map<Integer, String> gluedExpression) {
    ...
    private void formGluedExpression(Map<Integer, String> gluedExpression){
    ...
    private void formTable(Map<Integer, String> gluedExpression,List<String> constituents){
    ...
    private void createTable(List<String> constituents, Map<Integer, String> gluedExpression, int type) {
        table = new ArrayList<>();
    ...
    private List<String> getKonstituents(Map<Integer, String> SKNForSDNF) {
    ...
    public Map<Integer, String> applyMethod(Map<Integer, String> SKNForSDNF, int amnt, int type) {

        List<String> constituents = getKonstituents(SKNForSDNF);
        Map<Integer, String> gluedExpression = GluerOfLogicExpression.glueLogicExpression(SKNForSDNF, SKNForSDNF.size(), amnt);
