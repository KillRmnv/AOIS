...
public class UI {
    ...
    public void handleAddition() {
        ...
        List<Integer> sum = number1.Adding(number2.Getter());
    ...
    public void handleSubtraction() {
        ...
        BinNumber number2 = new BinNumber();
        number2.Setter(binConverter.ConvertToBin(num2));
        List<Integer> result = number1.Subtracting(number2.Getter());
    ...
    public void handleMultiplication() {
        ...
        BinNumber number2 = new BinNumber();
        number2.Setter(binConverter.ConvertToBin(num2));
        List<Integer> result = number1.multiplication(number2.Getter());
    ...
    public void handleDivision() {
        ...
        BinNumber number2 = new BinNumber();
        number2.Setter(binConverter.ConvertToBin(num2));
        List<Integer> result = number1.division(number2.Getter());
    ...
    public void handleFloatAddition() {
        ...
        List<Integer> result = numberFloat1.Adding(numberFloat2.Getter());
