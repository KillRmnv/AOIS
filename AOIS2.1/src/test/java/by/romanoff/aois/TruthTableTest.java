...
class TruthTableTest {
    ...
    void setUp() {
        ...
        expressions = parser.parseOnBasicExpressions("(a&b)|!c~(d->e)", Statements);
    ...
    void testAllPossibleCombinations() {
        ...
        assertArrayEquals(new Integer[]{0, 0, 0, 1, 0, 1, 0, 0, 1, 0}, combinations.get(2).subList(0, 10).toArray());
        assertArrayEquals(new Integer[]{0, 0, 1, 1, 1, 0, 0, 1, 0, 0}, combinations.get(7).subList(0, 10).toArray());
    }
